...
public interface ISwFileReader {
	 ...
	 * @param textFile is a text file that must respect the rules described above.
	 * @return a 'syntactic grove', i.e. a list of syntactic trees with some more functionalities. 
	 */
	ISyntacticGrove getSyntacticGrove(Object textFile) throws SwTreeGenException, SwFileReaderException;
