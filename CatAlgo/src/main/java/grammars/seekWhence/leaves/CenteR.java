...
/**
 * CenteR represents a terminal symbol of the context-free grammar associated with the microworld 'SeekWhence'. 
 * Any instance of this class represents a leaf of a syntactic tree generated using this grammar.
 * @author Gael Tregouet
 *
 */
public final class CenteR extends SyntacticLeaf implements ISyntacticLeaf {
	...
	public ISyntacticStructure clone() {
		return new CenteR(super.getLeafID());
	}
