...
/**
 * IEndPositionValue is an interface used for the implementation of a disjunctive rule in the context-free grammar 
 ...
 *
 */
public interface IEndPositionValue extends ISyntacticStructure {
