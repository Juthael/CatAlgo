...
/**
 * IDirectionValue is an interface used for the implementation of a disjunctive rule in the context-free grammar 
 ...
 *
 */
public interface IDirectionValue extends ISyntacticStructure {
