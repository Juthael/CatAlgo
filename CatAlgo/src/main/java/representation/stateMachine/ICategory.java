...
/**
 * <p> 
 * A <i>category</i> is composed of an <i> intent </i> that defines what this category <i> is </i>, 
 * and of an <i> extent </i> that specifies which objects conform to this definition. 
 ...
 * equally be provided as a relational description, as a functional expression or as a regular language, i.e. 
 ...
 * Hence, each word accepted by a category machine is a functional expression that denotes a <i>property</i> 
 * of this category. 
 * </p> 
 * 
 * <p>
 ...
 * these values, displays a procedure that transforms one "category" machine into another (dimensions 
...
public interface ICategory extends IStateMachine, IState {
	...
	/**
	 * <p>
	 * Returns the transition function of a categorical state machine whose intent is the specified 
	 * description. <br>
	 * </p>
	 * 
	 * @see representation.dataFormats.IDescription
	 * @see representation.stateMachine.IStateMachine
	 * @param a relational description
	 * @return the transition function of a categorical state machine whose intent is the specified 
	 * relational description.
	 */
	ITransitionFunction buildTransitionFunction(IRelationalDescription relationalDescription);
	
	/**
	 * <p>
	 * Returns the intent of this category (i.e., its meaning). <br>
	 * </p>
	 * 
	 * <p>
	 * The intent of a category is a description that can indifferently have the form of a relational 
	 * description, of a functional expression, or of a regular language. <br>
	 * </p> 
	 * 
	...
	/**
	 * <p>
	 * Returns the extent of this category (i.e., the set of objects to which it applies and which are 
	 * instances of this category). <br>
	 * </p> 
	 * 
	 * @return the extent of the category
	 */
	Set<IContextObject> getExtent();
	
	/**
	 * <p>
	 * Returns the transition rule allowing a transition from this category to the specified category, 
	 * provided that the latter is a sub-category of this one. <br>
	 * </p>
	 * 
	 * <p>
	 ...
	 * 
	 * <p> 
	 * If the specified category is truly a sub-category, then the transition is built. The input state will 
	 ...
	 * transition function of a representational state machine can be inferred from the systematic 
	 * comparison of its "category" states. <br>
	 * </p>
	 * 
	 * @see representation.stateMachine.ITransitionFunction
	 * @see representation.stateMachine.IRepresentation
