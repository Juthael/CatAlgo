...
public interface IContextObject extends ICategory, IAcceptState {
	...
	/**
	 * Verifies that the object has the specified successorRelation, expressed as a functional expression. <br>
	 * 
	 ...
	 * 
	 * @param specifiedProperty the successorRelation to be sought in the object, expressed as a functional expression
	 * @return true if the specified successorRelation has been found ; false otherwise
	 */
