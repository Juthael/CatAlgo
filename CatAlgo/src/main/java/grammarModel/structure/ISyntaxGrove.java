...
/**
 * ISyntaxGrove is a container of syntax trees, i.e. syntax branches ({@link ISyntaxBranch}) whose name is the start element of
...
public interface ISyntaxGrove extends ISyntaxBranch {
	 ...
	 * with different 'poset element ID', the tree paths generated by every structure in the grove are first 
