...
public interface ISyntacticStructure extends Cloneable {
	...
	/**
	 * Returns the list of IDs associated with any terminal ({@link ISyntaxLeaf}) derived from a structure's minimum.
	 * 
	 * @see grammarModel.structure.ISyntaxLeaf
	 * @return the list of IDs associated with any terminal ({@link ISyntaxLeaf}) derived from this structure's minimum. 
	 */
	 ...
	 * 
	 * <p>
	 * No structure replacement ( {@link ISyntaxBranch#replaceComponents(ISyntacticStructure, List)}) is allowed 
